...
public class MallGoodsCategoryController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        CategorisListVO categorisListVO = new CategorisListVO(Integer.parseInt(params.get("page").toString()), Integer.parseInt(params.get("limit").toString()));
        if (params.get("categoryLevel") != null) {
            categorisListVO.setCategoryLevel(Integer.parseInt(params.get("categoryLevel").toString()));
        }
        if (params.get("parentId") != null) {
            categorisListVO.setParentId(Long.parseLong(params.get("parentId").toString()));
        }
        return ResultGenerator.genSuccessResult(mallCategoryService.getCategoriesPage(categorisListVO));
    }
