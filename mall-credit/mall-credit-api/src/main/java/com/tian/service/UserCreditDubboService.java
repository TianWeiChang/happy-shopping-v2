 ...
 * 用户积分
 */
public interface UserCreditDubboService {
     ...
     */
    Result<UserCreditDto> addCredit(ModifyCreditDto modifyCreditDto);
     ...
     * @throws Exception 添加积分异常信息
     */
    Result<UserCreditDto> reduceCredit(ModifyCreditDto modifyCreditDto) ;
     ...
     * @return 是否成功
     */
    Result preReduceCredit(ModifyCreditDto modifyCreditDto);
